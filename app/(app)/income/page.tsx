...
import { MobileIncome } from "@/components/income/mobile-income";
import { currentPeriod, type HalfPeriod } from "@/lib/periods";
...
export default async function IncomePage({
  ...
  const highlightPeriod: HalfPeriod | null = isCurrentMonth
    ...
    : null;
  const defaultPeriod: "H1" | "H2" = highlightPeriod ?? "H1";
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <MobileIncome
        ...
        totalH1={data.totalH1}
        totalH2={data.totalH2}
      ...
      <div className="hidden space-y-6 md:block">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <AddIncomeForm year={year} month={month} defaultPeriod={defaultPeriod} />
          <DonutChart
            title="Composition"
