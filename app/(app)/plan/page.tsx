...
import { MobilePlan } from "@/components/plan/mobile-plan";
...
export default async function PlanPage({
  ...
  const allocationCenterLabel =
    matrix.grandTotal === null
      ? "Unavailable"
      : formatMinor(matrix.grandTotal, settings.reportingCurrency);
  ...
  return (
    <div>
      <MobilePlan
        ...
        allocationCenterLabel={allocationCenterLabel}
      />
